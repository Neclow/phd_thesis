\begin{figure}[htbp]
    ...
    \end{tikzpicture}
    \caption{Illustration of the parsing from a Newick string to the “ancestry” object (also referred to as the “ancestry” matrix in Scheidwasser \textit{et al.}~\cite{scheidwasser2025}). In the absence of parental nodes, the third element of the triplet is assigned as the maximum of the two first elements, and we keep the minimum.}
