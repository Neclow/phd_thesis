\begin{figure}
    ...
    \toprule
    \textbf{State} & \textbf{Action} & \textbf{Tree} \\
    \midrule
    ...
    \end{tikzpicture}} \\
    2 cherries: (0,2), (3,4) \newline Next parent = 5 & $\max(0, 2, 3, 4) = 4$ \newline Label the parent of 4 as 5 \newline Prune leaf \textbf{4} & \adjustbox{valign=t}{\begin{tikzpicture}[thick, >=Stealth, scale=0.75, every node/.style={scale=0.75}]
        % Nodes
        \node[circle, fill=gray, text=white] (R) at (2.5, 4) {};
        \node[circle, fill=black, text=white] (6) at (2.5, 3) {};
        \node[circle, fill=Peach] (5) at (1.5, 2) {};
    ...
    \end{tikzpicture}} \\
    1 cherry: (0,2) \newline Next parent = 6 & $\max(0, 2) = 2$ \newline Label the parent of 2 as 6 \newline Prune leaf \textbf{2} & \adjustbox{valign=t}{\begin{tikzpicture}[thick, >=Stealth, scale=0.75, every node/.style={scale=0.75}]
        % Nodes
        \node[circle, fill=gray, text=white] (R) at (2.5, 4) {};
        \node[circle, fill=black, text=white] (6) at (2.5, 3) {};
        \node[circle, fill=Peach] (5) at (1.5, 2) {};
        ...
        \draw[->] (M) -- (3) node[midway, sloped, above] {3};
    \end{tikzpicture}} \\
    1 cherry: (0,1) \newline Next parent = 7 & $\max(0, 1) = 1$ \newline Label the parent of 1 as 7 \newline Prune leaf \textbf{1} & \adjustbox{valign=t}{\begin{tikzpicture}[thick, >=Stealth, scale=0.75, every node/.style={scale=0.75}]
        % Nodes
        \node[circle, fill=gray, text=white] (R) at (2.5, 4) {};
        \node[circle, fill=black, text=white] (6) at (2.5, 3) {};
        ...
        \draw[->] (M) -- (3) node[midway, sloped, above] {3};
    \end{tikzpicture}} \\
    1 cherry: (0,3) \newline Next parent = 8 & $\max(0, 3) = 3$ \newline Label the parent of 1 as 8 \newline Prune leaf \textbf{3} & \adjustbox{valign=t}{\begin{tikzpicture}[thick, >=Stealth, scale=0.75, every node/.style={scale=0.75}]
        % Nodes
        \node[circle, fill=gray, text=white] (R) at (2.5, 4) {};
